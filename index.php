...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/food_bg1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5" id="section-home">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person">
              <img src="images/putin.jpg" alt="Image" class="img-fluid rounded mb-5 w-75 rounded-circle">
              <h3>Abhishek S</h3>
              <p class="position text-muted">USN:1AT20IS004</p>
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person">
              <img src="images/harsh.jpg" alt="Image" class="img-fluid rounded mb-5 w-75 rounded-circle">
              <h3>Harsha BH</h3>
              <p class="position text-muted">USN:1AT20IS030</p>
              <ul class="ul-social-circle">
                <li><a href="#"><span class="icon-facebook"></span></a></li>
                <li><a href="#"><span class="icon-twitter"></span></a></li>
                <li><a href="#"><span class="icon-linkedin"></span></a></li>
